    ...
    public static class DataProtectionExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddDataProtection()
                ...
                .ProtectKeysWithAzureKeyVault(keyIdentifier: config.EncryptionKeyUrl,clientId: config.ClientId, clientSecret: config.Secret);
        ...
        private static Config GetConfig(IConfiguration configuration)
        {
            return new Config(connectionString: configuration.GetConnectionString("ConnectionString") ?? "",
                ...
                secret: configuration["Vault:ClientSecret"] ?? "");
        }
