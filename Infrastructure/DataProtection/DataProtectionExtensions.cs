...
namespace Infrastructure.DataProtection
{
    ...
    public static class DataProtectionExtensions
    {
        public static void AddDataProtectionWithSqlServer(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string clientSecret  = configuration["Vault:ClientSecret"] ?? "";
            ...
            services.AddDataProtection()
                ...
                .ProtectKeysWithAzureKeyVault(keyIdentifier: encryptionKeyUrl, clientId: clientId, clientSecret: clientSecret);
